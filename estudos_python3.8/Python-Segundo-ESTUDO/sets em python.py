#add (adiciona) , update(atauliza), clear, discard
#union | (une)
# intersection & ( todos os elementos presentes no dois sets)
# difference - (elementos apenas em set da esquerda)
#symmetric_difference ^ (elementos que estão no mesmo sets, mas não em ambs)
